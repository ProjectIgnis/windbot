...
reg add 'HKCU\SOFTWARE\Xamarin\VisualStudio\'$INSTALLATION_ID'\Android' -v JavaSdkDirectory -t REG_SZ -d "$JAVA_HOME_8_X64" -f
...
(yes || true) | ${ANDROID_SDK_ROOT}/cmdline-tools/latest/bin/sdkmanager.bat --sdk_root=$ANDROID_SDK_ROOT "build-tools;32.0.0" "cmdline-tools;7.0" "ndk;24.0.8215888" "platforms;android-24" "platforms;android-25" "platforms;android-32"
